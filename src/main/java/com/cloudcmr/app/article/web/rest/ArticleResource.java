...
public class ArticleResource {
     ...
     * @return the ResponseEntity with getStatus 201 (Created) and with body the new article, or with getStatus 400 (Bad Request) if the article has already an ID
     ...
     * @return the ResponseEntity with getStatus 200 (OK) and with body the updated article,
     * or with getStatus 400 (Bad Request) if the article is not valid,
     * or with getStatus 500 (Internal Server Error) if the article couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/articles")
    @Timed
     ...
     *
     * @return the ResponseEntity with getStatus 200 (OK) and the list of articles in body
     */
    @GetMapping("/articles")
    @Timed
     ...
     * @return the ResponseEntity with getStatus 200 (OK) and with body the article, or with getStatus 404 (Not Found)
     */
